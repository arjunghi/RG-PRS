        ...
        <div className="grid md:grid-cols-2 gap-6 items-stretch">
          ...
          <div className="bg-slate-50 border border-slate-100 rounded-xl p-5 flex flex-col justify-between">
            <div className="space-y-3.5">
              ...
              <p className="text-xs text-slate-500 leading-normal">
                Already have a master spreadsheets file or backup copy? Paste the spreadsheet folder URL or ID to connect.
              </p>
            ...
            <div className="text-[10px] text-slate-400 font-medium leading-relaxed mt-4">
              Note: Make sure your connected account has access permissions for the pasted Spreadsheet.
            </div>
          </div>
        </div>
      </div>
